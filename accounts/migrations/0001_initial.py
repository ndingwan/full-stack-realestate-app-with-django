    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Regular User'), ('agent', 'Real Estate Agent'), ('admin', 'Administrator')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_bathrooms', models.IntegerField(blank=True, null=True)),
